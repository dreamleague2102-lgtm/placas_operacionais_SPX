...
document.getElementById('print-saida').addEventListener('click', async () => {
  ...
  for (let i = 0; i < itens.length; i++) {
    ...
    pages += `<section class="out-print-page" style="width:10.98in;height:8.48in;position:relative;overflow:hidden;background:#fff;break-after:page;page-break-after:always;">
      <!-- Placa Grande ${i+1} -->
      <div style="position:absolute;left:0.58in;top:1.46in;width:9.82in;height:5.56in;
        border:1.5px solid #111;box-sizing:border-box;"></div>
      <!-- Stripe top-left -->
      <div class="stripe-five" style="position:absolute;left:0.58in;top:1.46in;width:4.20in;height:0.28in;"></div>
      <!-- Stripe bottom-right -->
      <div class="stripe-five" style="position:absolute;right:0.58in;bottom:1.46in;width:4.20in;height:0.28in;"></div>
      <!-- Nome OUT -->
...
document.getElementById('print-nome').addEventListener('click', () => {
  ...
  const placa = (item) => {
    ...
    return `<section class="simple-print-page" style="width:10.98in;height:8.48in;padding:1.46in .58in;overflow:hidden;page-break-after:always;break-after:page;background:#fff;">
